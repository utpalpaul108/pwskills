...
model = pickle.load(open('model/svcModelforDiabetesPrediction.pkl','rb'))
...
def predict_datapoint():
   if request.method == 'POST':
      ...
      if predicted_result[0] == 1:
         result = 'Diabetic'
      return render_template('home.html',title="Support Vector Classification", result=result)
   else:
      return render_template('home.html', title="Support Vector Classification")
